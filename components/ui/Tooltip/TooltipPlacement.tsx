import { PlacementTypes } from '@lib/prop-types'
...
export const getPosition = (
  ...
  const positions: { [key in PlacementTypes]: TooltipPosition } = {
    top: {
...
export const getIconPosition = (
  ...
  const positions: { [key in PlacementTypes]?: TooltipIconPosition } = {
    top: {
      top: 'auto',
      right: 'auto',
      left: '50%',
